...
function MyDoubleCilinder(scene, slices, stacks, minS = 0, maxS = 1, minT = 0, maxT= 1) {
...
MyDoubleCilinder.prototype = Object.create(CGFobject.prototype);
MyDoubleCilinder.prototype.constructor = MyDoubleCilinder;

MyDoubleCilinder.prototype.initBuffers = function() {
  this.vertices = [];
  this.indices = [];
  this.normals = [];
  this.texCoords = [];
    ...
    this.vertices.push(coord_x, coord_y, height);
 	...
 	this.texCoords.push(x_Coord, y_Coord);
      ...
      if(i !== 0 && j !== 0) {
        ...
        //in
        this.indices.push(index-1,index-index_incr-1,index);
        this.indices.push(index-index_incr-1,index-index_incr,index);
    }
